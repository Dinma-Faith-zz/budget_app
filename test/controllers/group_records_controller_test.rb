...
class GroupRecordsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create group_record" do
    assert_difference("GroupRecord.count") do
      post group_records_url, params: { group_record: { group_id: @group_record.group_id, record_id: @group_record.record_id } }
    end
  ...
  test "should update group_record" do
    patch group_record_url(@group_record), params: { group_record: { group_id: @group_record.group_id, record_id: @group_record.record_id } }
